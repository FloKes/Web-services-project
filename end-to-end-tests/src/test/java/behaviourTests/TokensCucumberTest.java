...
@CucumberOptions(plugin="summary",
         publish= false,
         features = "src/test/java/behaviourTests/features/tokens.feature",  // directory of the feature files
         glue = {"behaviourTests.steps.tokenSteps"}
)
public class TokensCucumberTest {
}
