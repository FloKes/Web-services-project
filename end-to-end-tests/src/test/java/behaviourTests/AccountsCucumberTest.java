...
@CucumberOptions(plugin="summary",
         publish= false,
         features = "src/test/java/behaviourTests/features/accounts.feature",  // directory of the feature files
         glue = {"behaviourTests.steps.accountSteps"}
)
public class AccountsCucumberTest {
}
